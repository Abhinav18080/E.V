...
Models (User, UserSession, ApprovalRecord) live in app/db/models.py, which
import this module's Base to register themselves on it. This module only
owns the connection plumbing: engine, session factory, and the Base class
itself.
"""
